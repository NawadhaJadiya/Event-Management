          ...
          <div key={event.id} className="bg-secondary rounded-lg shadow-md p-6 group hover:shadow-xl transition-all duration-300">
            <div className="flex items-start gap-6">
              ...
              <div className="flex flex-col gap-2">
                <button className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-accent transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                <Link to="/registered-students" className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-accent transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                  View Registrations
                </Link>
                </button>
