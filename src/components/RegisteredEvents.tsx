          ...
          <div key={event.id} className="bg-secondary rounded-lg shadow-md overflow-hidden group hover:shadow-xl transition-all duration-300">
            <div className="flex">
              ...
              <div className="w-48 p-6 bg-secondary-light flex flex-col justify-center items-center border-l border-gray-600">
                ...
                <button className="w-full px-4 py-2 bg-primary text-white rounded-lg hover:bg-accent transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                <Link to="/qrcode" className="w-full px-4 py-2 bg-primary text-white rounded-lg hover:bg-accent transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                  View Details
                </Link>
                </button>
              </div>
